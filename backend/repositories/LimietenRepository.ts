...
const DEFAULT_LIMIETEN: LimietInput[] = [
    ...
    { parameter_naam: 'actie_spoelbeurt_dagen', min_waarde: 0.00,  max_waarde: 7.00       },
    { parameter_naam: 'actie_floculant_min',    min_waarde: 0.00,  max_waarde: 10.00      },
    { parameter_naam: 'actie_gebonden_chloor_max',      min_waarde: 0.00, max_waarde: 1.00  },
    { parameter_naam: 'actie_chloor_peuterbad_min',     min_waarde: 0.00, max_waarde: 10.00 },
    { parameter_naam: 'actie_zwavelzuur_peuterbad_min', min_waarde: 0.00, max_waarde: 5.00  },
...
export class LimietenRepository implements ILimietenRepository {
    ...
    async getAll(): Promise<LimietenMap> {
        ...
        (rows as Array<{ parameter_naam: string; min_waarde: string; max_waarde: string }>)
            .forEach(r => { obj[r.parameter_naam] = { min: parseFloat(r.min_waarde), max: parseFloat(r.max_waarde) }; });
    ...
    getDefaults(): LimietenMap {
        const obj: LimietenMap = {};
        DEFAULT_LIMIETEN.forEach(l => { obj[l.parameter_naam] = { min: l.min_waarde, max: l.max_waarde }; });
        return obj;
    }
