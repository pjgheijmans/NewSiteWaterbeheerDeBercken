...
import { ILogboekRepository } from './ILogboekRepository';

export class LogboekRepository implements ILogboekRepository {
    ...
    async deleteById(id: string): Promise<void> {
        await this.pool.execute<ResultSetHeader>('DELETE FROM logboek WHERE id = ?', [id]);
    }
}
