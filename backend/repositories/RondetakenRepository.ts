...
export class RondetakenRepository implements IRondetakenRepository {
    ...
    static get CATALOGUS(): readonly RondetaakDefinitie[] {
        return [
            // Kritiek
            {
                sleutel: 'regelaar_diep',
                gebied: 'Diep',
                label: 'Regelaar diep gereinigd',
                prioriteit: 'kritiek',
                pagina: 'grote-baden',
            },
            {
                sleutel: 'regelaar_ondiep',
                gebied: 'Ondiep',
                label: 'Regelaar ondiep gereinigd',
                prioriteit: 'kritiek',
                pagina: 'grote-baden',
            },
            {
                sleutel: 'regelaar_peuterbad',
                gebied: 'Peuterbad',
                label: 'Regelaar peuterbad gereinigd',
                prioriteit: 'kritiek',
                pagina: 'peuterbad',
            },
            {
                sleutel: 'filters_spraypark',
                gebied: 'Spraypark',
                label: 'Filters spraypark gereinigd',
                prioriteit: 'kritiek',
                pagina: 'peuterbad',
            },
            {
                sleutel: 'douches_test',
                gebied: 'Douches',
                label: 'Douches getest',
                prioriteit: 'kritiek',
                pagina: 'grote-baden',
            },
            // Normaal
            {
                sleutel: 'diep_filter',
                gebied: 'Diep',
                label: 'Diep filter gereinigd',
                prioriteit: 'normaal',
                pagina: 'grote-baden',
            },
            {
                sleutel: 'diep_haarfilter',
                gebied: 'Diep',
                label: 'Diep haarfilter gereinigd',
                prioriteit: 'normaal',
                pagina: 'grote-baden',
            },
            {
                sleutel: 'ondiep_filter',
                gebied: 'Ondiep',
                label: 'Ondiep filter gereinigd',
                prioriteit: 'normaal',
                pagina: 'grote-baden',
            },
            {
                sleutel: 'ondiep_haarfilter',
                gebied: 'Ondiep',
                label: 'Ondiep haarfilter gereinigd',
                prioriteit: 'normaal',
                pagina: 'grote-baden',
            },
            {
                sleutel: 'peuterbad_filter',
                gebied: 'Peuterbad',
                label: 'Peuterbad filter gereinigd',
                prioriteit: 'normaal',
                pagina: 'peuterbad',
            },
            {
                sleutel: 'peuterbad_haarfilter',
                gebied: 'Peuterbad',
                label: 'Peuterbad haarfilter gereinigd',
                prioriteit: 'normaal',
                pagina: 'peuterbad',
            },
            {
                sleutel: 'glijbaan_haarfilter',
                gebied: 'Glijbaan',
                label: 'Glijbaan haarfilter gereinigd',
                prioriteit: 'normaal',
                pagina: 'grote-baden',
            },
            {
                sleutel: 'speeltoestel_ondiep_haarfilter',
                gebied: 'Speeltoestel',
                label: 'Speeltoestel ondiep haarfilter gereinigd',
                prioriteit: 'normaal',
                pagina: 'grote-baden',
            },
            {
                sleutel: 'douches_filter',
                gebied: 'Douches',
                label: 'Douches filter gereinigd',
                prioriteit: 'normaal',
                pagina: 'grote-baden',
            },
        ];
    ...
    static badVoorFilterSleutel(sleutel: string): string | undefined {
        return Object.entries(RondetakenRepository.FILTER_SLEUTEL_PER_BAD).find(
            ([, s]) => s === sleutel,
        )?.[0];
    }
