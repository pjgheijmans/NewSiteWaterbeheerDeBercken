...
export class RondetakenRepository implements IRondetakenRepository {
     ...
     * 'kritiek' = moet dagelijks gebeuren (anders hindert het de regelaars/spraypark);
     * 'normaal' = kan tijdens een ronde gebeuren.
     */
    static get CATALOGUS(): readonly RondetaakDefinitie[] {
        return [
            ...
            { sleutel: 'douches_test',               gebied: 'Douches',      label: 'Douches getest',                        prioriteit: 'normaal', pagina: 'grote-baden' },
