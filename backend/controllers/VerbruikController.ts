...
export class VerbruikController {
    ...
    constructor(private readonly service: IVerbruikService) {
        this.router = Router();
        this.router.get('/diep-ondiep',        checkAuth, vereist('waterbeheer', 'lezen'),     this.getVerbruik.bind(this));
        this.router.get('/diep-ondiep/vorige', checkAuth, vereist('waterbeheer', 'lezen'),     this.getVorigeVerbruik.bind(this));
        this.router.post('/diep-ondiep',       checkAuth, vereist('waterbeheer', 'schrijven'), valideerBody(verbruikSchema), vereistHistorieRecht, this.postVerbruik.bind(this));
        this.router.get('/verwarmingssysteem',  checkAuth, vereist('waterbeheer', 'lezen'),     this.getVerwarming.bind(this));
        this.router.post('/verwarmingssysteem', checkAuth, vereist('waterbeheer', 'schrijven'), valideerBody(verwarmingSchema), vereistHistorieRecht, this.postVerwarming.bind(this));
    }
