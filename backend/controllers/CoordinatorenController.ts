...
export class CoordinatorenController {
    ...
    constructor(private readonly service: ICoordinatorenService) {
        this.router = Router();
        this.router.get('/',                  checkAuth, vereist('coordinator', 'lezen'),     this.getMetingen.bind(this));
        this.router.post('/',                 checkAuth, vereist('coordinator', 'schrijven'), valideerBody(coordinatorMetingSchema), vereistHistorieRecht, this.postMeting.bind(this));
        this.router.get('/checklist',         checkAuth, vereist('coordinator', 'lezen'),     this.getChecklist.bind(this));
        this.router.post('/checklist',        checkAuth, vereist('coordinator', 'schrijven'), valideerBody(checklistSchema), vereistHistorieRecht, this.postChecklist.bind(this));
        this.router.get('/daggegevens',       checkAuth, vereist('coordinator', 'lezen'),     this.getDaggegevens.bind(this));
        this.router.post('/daggegevens',      checkAuth, vereist('coordinator', 'schrijven'), valideerBody(daggegevensSchema), vereistHistorieRecht, this.postDaggegevens.bind(this));
        this.router.delete('/',               checkAuth, vereist('coordinator', 'schrijven'), vereistHistorieRecht, this.deleteBlok.bind(this));
        this.router.get('/logboek',           checkAuth, vereist('coordinator', 'lezen'),     this.getLogboek.bind(this));
        this.router.post('/logboek',          checkAuth, vereist('coordinator', 'schrijven'), valideerBody(logboekSchema), vereistHistorieRecht, this.postLogboek.bind(this));
        this.router.delete('/logboek/:id',    checkAuth, vereist('coordinator', 'schrijven'), this.deleteLogboek.bind(this));
    }
