...
export class MetingenController {
    ...
    constructor(private readonly service: IMetingenService) {
        ...
        this.router.post('/metingen',             checkAuth, vereist('waterbeheer', 'schrijven'), valideerBody(metingSchema), vereistHistorieRecht, this.postMeting.bind(this));
        this.router.get('/acties',                checkAuth, vereist('waterbeheer', 'lezen'),     this.getActies.bind(this));
        this.router.post('/acties/:id/resolve',   checkAuth, vereist('waterbeheer', 'schrijven'), this.resolveActie.bind(this));
        this.router.get('/bezoekers',             checkAuth, vereist('waterbeheer', 'lezen'),     this.getBezoekers.bind(this));
        this.router.get('/gebonden-chloor',       checkAuth, vereist('waterbeheer', 'lezen'),     this.getGebondenChloor.bind(this));
        this.router.post('/acties/:id/unresolve', checkAuth, vereist('waterbeheer', 'schrijven'), this.unresolveActie.bind(this));
    }
