...
*Describe the purpose of this document and the element it specifies.*

### 1.2 Scope

*Define the boundaries of this element — what it does and explicitly what it does not do.*
...
*A concise description of the element — what it is and what problem it solves.*

### 2.2 Functional Summary

*High-level list of the primary functions this element performs.*
...
*Diagram or description showing the element in context with surrounding systems, users, and data flows.*
...
*Describe the overall navigation structure (e.g. top nav, sidebar, breadcrumbs, modal flows).*
...
*List any functional limitations or boundaries that the element must operate within.*
...
*Define concurrent user targets, request rates, data volumes, etc.*
...
*Relevant for calculations, search results, data display, etc.*
...
*Hosting environment, ports, certificates, DNS, etc.*
...
*Minimum browser versions, JavaScript requirements, cookie/storage requirements.*

### 6.3 Network Requirements

*Bandwidth assumptions, latency tolerance, offline behaviour, etc.*
...
*GDPR, data retention, cookie consent, etc.*

### 7.3 Design Constraints

*Technology choices, existing infrastructure, team skills, budget, etc.*
...
*High-level conditions that must be met for the element to be accepted as complete.*
