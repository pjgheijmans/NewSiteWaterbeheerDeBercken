...
describe('VerbruikModule.laadEnBerekenVerbruik (Diep/Ondiep)', () => {
    it('vult alle verbruik-cellen met het verschil t.o.v. de vorige dag', async () => {
        const velden = ['water-diep', 'water-ondiep', 'water-totaal', 'elektriciteit-nacht',
        ...
        const huidig = {
            water_diep: 1000, water_ondiep: 500, water_totaal: 1500, elektriciteit_nacht: 200,
            elektriciteit_dag: 300, gas: 80, floculant: 12, chemicalien_chloor: 40, chemicalien_zwavelzuur: 15,
        };
        const vorige = {
            water_diep: 900, water_ondiep: 450, water_totaal: 1350, elektriciteit_nacht: 180,
            elektriciteit_dag: 250, gas: 70, floculant: 10, chemicalien_chloor: 50, chemicalien_zwavelzuur: 20,
        };
        ...
        const val = (id: string) => (document.getElementById(`${id}-verbruik`) as HTMLInputElement).value;
    ...
    it("zet '-' wanneer de huidige stand ontbreekt", async () => {
        document.body.innerHTML =
            `<input id="centraleDatum" value="2026-07-15"><input id="gas-verbruik">`;
        const app: any = {
